      ...
      <div className={"container " + (classicHeader ? "" : "px-lg-5")}>
        ...
        <div className="row gy-5">
          ...
          <div className="col-lg-12 col-xl-12 text-center text-lg-start">
            ...
            <p className={darkTheme ? "text-white-50" : ""}>
            I am driven by my passion for continuous learning and self-improvement, and I am committed to expanding my knowledge and skillset in both my professional and personal life. This drive is evident in the diverse range of hobbies and interests I have acquired over the years, including plumbing, wood-working, automotive repair, PC building, and crafting. These experiences have helped me develop valuable skills that are transferable to software development such as attention to detail, multitasking, independence, proficiency in working with complex systems, and the ability to work under pressure.
            </p>
            <p className={darkTheme ? "text-white-50" : ""}>
